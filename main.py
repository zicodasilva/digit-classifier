...
n_dim = 28 * 28
n_output = 10
training_set, testing_set = lib.load_mnist_dataset()
# Define a model.
n_features = 32
...
# Train model.
results = lib.train_model(model, opt, training_set, testing_set, 50)
# Predict a random image. /Users/zico/.fastai/data/mnist_png/testing/8
print(lib.classify(model, "/Users/zico/.fastai/data/mnist_png/testing/8/290.png", n_dim))
